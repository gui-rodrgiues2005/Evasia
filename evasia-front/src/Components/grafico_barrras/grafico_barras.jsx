...
const GraficoRisco = ({ quantidade, loading }) => {
  ...
  if (loading) {
    return (
      <div style={{
        ...
        <div className="skeleton skeleton-title" style={{ width: '40%', height: 24, marginBottom: 16 }} />
        <div className="skeleton" style={{ width: '100%', height: 180, marginBottom: 8 }} />
        <div className="skeleton skeleton-sub" style={{ width: '60%', height: 16 }} />
      </div>
    );
  }

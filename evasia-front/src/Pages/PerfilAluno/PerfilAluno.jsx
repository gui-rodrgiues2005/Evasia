...
const PerfilAluno = () => {
    ...
    function calcularConclusao(logs) {
        ...
        return total === 0 ? 0 : (acessados / total) * 100;
    }
    ...
    function calcularMedia(logs) {
        ...
        // Simulando notas com 100 fictício, pronto para ser substituído
        const somaNotas = avaliacoes.length * 100;
